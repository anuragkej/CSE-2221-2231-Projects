...
public final class BinarySearchTreeMethodsTest {
    ...
    public void testIsInTree2() {
         ...
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("4", "9", "10");
        BinaryTree<String> t2 = createBSTFromArgs("4", "9", "10");
        /*
         * Call method under test
         */
        boolean inTree = BinarySearchTreeMethods.isInTree(t1, "9");
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(true, inTree);
    ...
    public void testIsInTree3() {
         ...
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("9", "23", "34", "35987",
                "24744324", "2324");
        BinaryTree<String> t2 = createBSTFromArgs("9", "23", "34", "35987",
                "24744324", "2324");
        /*
         * Call method under test
         */
        boolean inTree = BinarySearchTreeMethods.isInTree(t1, "23");
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(true, inTree);
